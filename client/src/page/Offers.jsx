...
function Offers() {
    const Card = [
      ...
      return (
        <>
          <h1 className='font-bold text-4xl mt-10 ml-4 p-3'>Offer Products <span className='font-medium text-xl'>(30 Products Found)</span> </h1>
          <div className='flex flex-wrap'>
            <OffersItems text={Card} />           
          </div>
          <div className='my-10'>
